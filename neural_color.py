...
def main():
    ...
    if width is not None:
        ...
        content_image_gray = scipy.misc.imresize(content_image_gray, new_shape)
    ...
    for i in range(len(style_images)):
        ...
        style_images_gray[i] = scipy.misc.imresize(style_images_gray[i], style_scale *
                target_shape[1] / style_images_gray[i].shape[1])
    ...
    if initial is not None:
        initial = scipy.misc.imresize(imread(initial), content_image_gray.shape[:2])
